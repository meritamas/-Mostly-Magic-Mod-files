...
namespace MTMMM
{
    ...
    /// </summary>
    public class MTInventoryWindow : DaggerfallInventoryWindow
    {
        #region UI Rects
        ...
        public MTInventoryWindow(IUserInterfaceManager uiManager, DaggerfallBaseWindow previous = null)
        ...
        public override void OnPush()
        {
            ...
            DaggerfallWorkshop.Game.MagicAndEffects.MagicEffects.RacialOverrideEffect racialOverride = GameManager.Instance.PlayerEffectManager.GetRacialOverrideEffect();
        ...
        protected virtual void PaperDoll_OnMouseMove(int x, int y)
        {
            ...
            if (value != 0xff)
            {
                ...
                if (value >= 0 && value < ItemEquipTable.EquipTableLength)
                {
                    ...
                    // MT TODO: might be a good place for the code to show potion quality in more detail
                    // borrow DaggerfallUnity.Instance.ItemHelper.ResolveItemLongName(this) routine with a slight modification
