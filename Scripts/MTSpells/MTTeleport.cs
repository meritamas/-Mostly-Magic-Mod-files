// Project:         Advanced Teleportation mod for Daggerfall Unity (http://www.dfworkshop.net)   
// Copyright:       Copyright (C) 2020 meritamas
// License:         MIT License (http://www.opensource.org/licenses/mit-license.php)
// Author:          meritamas (meritamas@outlook.com)

// Class based on Teleport class which is part of the Daggerfall Tools For Unity project - many parts retained unchanged
        ...
        bool IsSameInterior(int index)
        {
            ...
            if (playerEnterExit.IsPlayerInsideBuilding && anchorPositions[index].insideBuilding)          
            {
                ...
                if (anchorPositions[index].buildingDiscoveryData.buildingKey == playerEnterExit.BuildingDiscoveryData.buildingKey)      
                {
                    ...
                    DaggerfallConnect.Utility.DFPosition anchorMapPixel = DaggerfallConnect.Arena2.MapsFile.WorldCoordToMapPixel(anchorPositions[index].worldPosX, anchorPositions[2].worldPosZ);
