...
{
    /// <summary>
    /// SpellReflection, inherited from classic for MMM
    /// </summary>
    public class MTSpellReflection : SpellReflection
    {
        /// <summary>
        /// The 'strength' of SpellReflection is in part its Chance of Success (the other parameter is Duration)
        ...
        /// <summary>
        /// The 'strength' of SpellReflection is in part its Duration (the other parameter is Chance of Success)
