...
{
    /// <summary>
    /// SpellResistance, inherited from classic for MMM
    /// </summary>
    public class MTSpellResistance : SpellResistance
    {
        /// <summary>
        /// The 'strength' of SpellResistance is in part its Chance of Success (the other parameter is Duration)
        ...
        /// <summary>
        /// The 'strength' of SpellResistance is in part its Duration (the other parameter is Chance of Success)
