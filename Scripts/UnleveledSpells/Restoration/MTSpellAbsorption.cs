...
{
    /// <summary>
    /// Spell Absorption, inherited from classic for MMM
    /// </summary>
    public class MTSpellAbsorption : SpellAbsorption
    {
        /// <summary>
        /// The 'strength' of SpellAbsorption is in part its Chance of Success (the other parameter is Duration)
        ...
        /// <summary>
        /// The 'strength' of SpellAbsorption is in part its Duration (the other parameter is Chance of Success)
