...
{
    /// <summary>
    /// SoulTrap, inherited from classic for MMM
    /// </summary>
    public class MTSoulTrap : SoulTrap
    {
        /// <summary>
        /// The 'strength' of SoulTrap is in part its Chance of Success (the other parameter is Duration)
        ...
        /// <summary>
        /// The 'strength' of SoulTrap is in part its Duration (the other parameter is Chance of Success)
