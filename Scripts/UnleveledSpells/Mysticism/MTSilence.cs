...
{
    /// <summary>
    /// Silence, inherited from classic for MMM
    /// </summary>
    public class MTSilence : Silence
    {
        /// <summary>
        /// The 'strength' of Silence is in part its Chance of Success (the other parameter is Duration)
        ...
        /// <summary>
        /// The 'strength' of Silence is in part its Duration (the other parameter is Chance of Success)
