...
{
    /// <summary>
    /// ContinuousDamageHealth, inherited from classic for MMM
    /// </summary>
    public class MTContinuousDamageHealth : ContinuousDamageHealth
    {
        /// <summary>
        /// The 'strength' of ContinuousDamageHealth is in part its Duration. (the other factor is Magnitude)
        ...
        /// <summary>
        /// The 'strength' of ContinuousDamageHealth is in part its Magnitude. (the other factor is Duration)
        ...
        public override void MagicRound()
        {
            ...
            // Implement effect           
            entityBehaviour.DamageHealthFromSource(this, MMMFormulaHelper.GetSpellMagnitude(this, manager), false, Vector3.zero);
        }
    }
}