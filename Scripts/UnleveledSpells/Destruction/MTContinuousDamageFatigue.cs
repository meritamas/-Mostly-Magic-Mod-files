...
{
    /// <summary>
    /// ContinuousDamageFatigue, inherited from classic for MMM
    /// </summary>
    public class MTContinuousDamageFatigue : ContinuousDamageFatigue
    {
        /// <summary>
        /// The 'strength' of ContinuousDamageFatigue is in part its Duration. (the other factor is Magnitude)
        ...
        /// <summary>
        /// The 'strength' of ContinuousDamageFatigue is in part its Magnitude. (the other factor is Duration)
        ...
        public override void MagicRound()
        {
            ...
            // Implement effect            
            entityBehaviour.DamageFatigueFromSource(this, MMMFormulaHelper.GetSpellMagnitude(this, manager), true);
        }
    }
}